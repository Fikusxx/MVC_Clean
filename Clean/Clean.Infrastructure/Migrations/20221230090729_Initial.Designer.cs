...
namespace Clean.Infrastructure.Migrations
{
    ...
    [Migration("20221230090729_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Clean.Core.Domain.Entities.Country", b =>
                {
            ...
            modelBuilder.Entity("Clean.Core.Domain.Entities.Person", b =>
                {
            ...
            modelBuilder.Entity("Clean.Core.Domain.IdentityEntities.ApplicationRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Clean.Core.Domain.IdentityEntities.ApplicationUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Clean.Core.Domain.Entities.Person", b =>
                {
                    b.HasOne("Clean.Core.Domain.Entities.Country", "Country")
                        .WithMany("Persons")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("Clean.Core.Domain.IdentityEntities.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("Clean.Core.Domain.IdentityEntities.ApplicationUser", null)
                        .WithMany()
